...
import { pushProfile, type ProfileData } from './services/push-profile'
...
export default function Page() {
	const [data, setData] = useState<ProfileData>(initialData as ProfileData)
	const [originalData, setOriginalData] = useState<ProfileData>(initialData as ProfileData)
			...
			<div className='flex flex-col items-center justify-center px-6 pt-32 pb-12 max-sm:px-0'>
				<div className='w-full max-w-[800px]'>
					...
					<div className='mt-8 flex items-center justify-center gap-6'>
						<LikeButton slug='profile' delay={0} />
					</div>
				</div>
			</div>
